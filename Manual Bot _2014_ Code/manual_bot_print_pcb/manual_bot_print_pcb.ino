...
//motor pins
          ...
          int right1=39  ; //right
          int right2=41  ; //right
          int behind1=31  ;//behind
          int behind2=33  ;//behind
          int left1=23  ;//left
          int left2=25  ;//left
          int fright1=22  ;//front right
          int fright2=24  ;//front right
          int fleft1=47  ;//front left
          int fleft2=49  ;//front left
          int bright1=35  ;//behind right
          int bright2=37  ;//behind right
          int bleft1=27  ;//behind left
          int bleft2=29  ;//behind left
          int larm1=26;//left arm
          int larm2=28;//left arm
          int sarm1=30;//swing arm
          int sarm2=32;//swing arm
...
//pnematic pins + solenoid + relays
          ...
          int rarm2=34  ; // see-saw arm
          int lg2=36  ; //autobot gripper 
          int sw2=38  ; //swing arm gripper
          int sus2=40; //suspension
          ...
          delay(100);
                       ...
                       {        
                            ...
                            else
                             {
                              ...
                              if(ps2x.Button(PSB_SELECT)||flag==2||flag==3||flag==4)
                              {
                                flag=2;
                                lcd.clear();
                                lcd.print("See-Saw");
                                ...
                                if(ps2x.Button(PSB_START)&&flag==2)
                                {
                                  ...
                                  if(ps2x.Button(PSB_SELECT)||flag==3||flag==4)
                                  {
                                    flag==3;
                                    lcd.clear();
                                    lcd.print("Swing");
                                  ...
                                  if(ps2x.Button(PSB_SELECT)||flag==4)
                                  {
                                    flag==4;
                                    lcd.clear();
                                    lcd.print("Pole Walk");
                                  ...
                                  if(ps2x.Button(PSB_SELECT)&&flag==4)
                                  {
                                    flag=1;
                                                                                                                   ...
                                                                                                                   else               //else for start if ,for timmer
                                                                                                                   {
